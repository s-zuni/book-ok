    ...
    return (
        <div className="max-w-4xl mx-auto py-8">
            <header className="mb-16 text-center lg:text-left">
                <h3 className="text-xs font-black text-[#01C54F] uppercase tracking-[0.3em] mb-4">Our Vision</h3>
            ...
            <div className="space-y-16">
                <div className="grid grid-cols-1 gap-10">
                    {visions.map((vision, index) => (
                        <div key={index} className="flex flex-col md:flex-row gap-8 items-start">
                            <div className={`p-4 rounded-3xl shrink-0 ${vision.color}`}>
                                <vision.icon size={32} />
                            </div>
                ...
                <div className="bg-[#1e2939] rounded-[2.5rem] p-10 md:p-14 text-white overflow-hidden relative">
                    <div className="relative z-10">
                        <Target className="text-[#01C54F] mb-6" size={40} />
                    ...
                    {/* Decorative element */}
                    <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#01C54F]/10 rounded-full blur-3xl" />
                </div>
            </div>
        </div>
    );
